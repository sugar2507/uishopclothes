...
export class CategoriesService {
  ...
  addCategory(emp: Categories) {
    return this.http.post<Categories>(this.addEmpUrl, emp).pipe(
      map((res: any) => {
        return res;
      })
    );
  ...
  getAllCategory() {
    return this.http.get<Categories>(this.getEmpUrl).pipe(
      map((res: any) => {
        return res;
      })
    );
  ...
  updateCategory(emp: Categories) {
    return this.http.put<Categories>(this.getEmpUrl, emp).pipe(
      map((res: any) => {
